...
#
# Usage:
#   bash <(curl -sSL https://raw.githubusercontent.com/uplift-labs/worktree-sandbox/main/remote-install.sh) [--prefix <dir>] [--with-claude-code] [--with-codex] [--with-opencode]
#
