...
echo "# stale adapter hook" > "$REPO/.uplift/sandbox/adapter/hooks/ghost-hook.sh"
echo "# stale adapter lib"  > "$REPO/.uplift/sandbox/adapter/lib/ghost.sh"
...
assert_file_absent "stale adapter hook removed" "$REPO/.uplift/sandbox/adapter/hooks/ghost-hook.sh"
assert_file_absent "stale adapter lib removed"  "$REPO/.uplift/sandbox/adapter/lib/ghost.sh"
