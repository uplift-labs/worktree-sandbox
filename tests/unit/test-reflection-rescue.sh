...
T1="$FIXTURE_ROOT/tp1"
mkdir -p "$T1/.sandbox/worktrees/wt-abc/.reinforce/reflections"
mkdir -p "$T1/.reinforce/reflections"
printf 'orphan content' > "$T1/.sandbox/worktrees/wt-abc/.reinforce/reflections/2026-01-01.md"
...
assert_file_absent "TP1: removed from worktree" "$T1/.sandbox/worktrees/wt-abc/.reinforce/reflections/2026-01-01.md"
...
echo "== TP-2: dedup =="
T2="$FIXTURE_ROOT/tp2"
mkdir -p "$T2/.sandbox/worktrees/wt-def/.reinforce/reflections"
mkdir -p "$T2/.reinforce/reflections"
printf 'main copy' > "$T2/.reinforce/reflections/dup.md"
printf 'wt copy' > "$T2/.sandbox/worktrees/wt-def/.reinforce/reflections/dup.md"

OUT2=$(bash "$RESCUE" --repo "$T2" 2>&1)
assert_contains "TP2: deduped line" "deduped:" "$OUT2"
assert_file_absent "TP2: removed from worktree" "$T2/.sandbox/worktrees/wt-def/.reinforce/reflections/dup.md"
...
T3="$FIXTURE_ROOT/tn1"
mkdir -p "$T3/.sandbox/worktrees/wt-ghi"
...
mkdir -p "$T5/.sandbox/worktrees/wt-aaa/.reinforce/reflections"
mkdir -p "$T5/.sandbox/worktrees/wt-bbb/.reinforce/reflections"
mkdir -p "$T5/.reinforce/reflections"
printf 'orphan-a' > "$T5/.sandbox/worktrees/wt-aaa/.reinforce/reflections/a.md"
printf 'main-b' > "$T5/.reinforce/reflections/b.md"
printf 'dup-b' > "$T5/.sandbox/worktrees/wt-bbb/.reinforce/reflections/b.md"
printf 'orphan-c' > "$T5/.sandbox/worktrees/wt-bbb/.reinforce/reflections/c.md"
...
assert_file_absent "MULTI: b.md removed from wt" "$T5/.sandbox/worktrees/wt-bbb/.reinforce/reflections/b.md"

# --- ENV: custom REFLECTION_RESCUE_DIR ---
echo "== ENV: custom REFLECTION_RESCUE_DIR =="
T6="$FIXTURE_ROOT/env"
mkdir -p "$T6/.sandbox/worktrees/wt-xyz/custom/data"
mkdir -p "$T6/custom/data"
printf 'custom orphan' > "$T6/.sandbox/worktrees/wt-xyz/custom/data/note.md"
...
assert_file_absent "ENV: removed from worktree" "$T6/.sandbox/worktrees/wt-xyz/custom/data/note.md"
